...
namespace Magpie.App
{
    ...
    {
        public static IList<CompileError> Run(string path, string argument, Action<string> printCallback)
        {
            return Run(path, argument, 0, printCallback);
        }

        public static IList<CompileError> Run(string path, string argument, int maxStackDepth, Action<string> printCallback)
        {
            sPrintCallback = printCallback;

            var foreign = new StreamForeign();
