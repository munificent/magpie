...
public class Checker {
   ...
   * 
   * @return Any type-check errors that were found. It isn't guaranteed that all
   *         errors will be found in a single pass since some errors may prevent
   ...
   * @param closure   The lexical scope where the function was defined. This is
   *                  expected to be a type scope, not a value scope (i.e. the
   *                  objects bound to names here should represent types
   *                  generated by the checker and not values generated by the
   *                  evaluator).
