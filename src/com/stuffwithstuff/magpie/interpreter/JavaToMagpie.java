...
public class JavaToMagpie {
  ...
  private Obj convertTokenType(TokenType type) {
    ...
    case COLON: tokenTypeValue = 6; tokenTypeName = "colon"; break;
    case COMMA: tokenTypeValue = 7; tokenTypeName = "comma"; break;
    case DOT: tokenTypeValue = 8; tokenTypeName = "dot"; break;
    ...
    case EOF: tokenTypeValue = 15; tokenTypeName = "eof"; break;
