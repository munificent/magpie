...
public abstract class BuiltIns {
  ...
  private static void registerMethod(ClassObj classObj, Class innerClass,
    ...
    try {
      ...
      BuiltIn builtIn = new BuiltIn(type, callable);
      if (isShared) {
        classObj.getClassObj().getMethods().put(methodName, builtIn);
      } else {
        classObj.getMethods().put(methodName, builtIn);
      }
    } catch (SecurityException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
  ...
  private static void registerGetter(ClassObj classObj, Class innerClass,
    ...
    try {
      ...
      BuiltIn builtIn = new BuiltIn(type, callable);
      if (isShared) {
        classObj.getClassObj().getGetters().put(methodName, builtIn);
      } else {
        classObj.getGetters().put(methodName, builtIn);
      }
    } catch (SecurityException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
